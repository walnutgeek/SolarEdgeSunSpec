...
@click.option("--out", default='human', help="json or human", type=click.Choice(['json','human'], case_sensitive=False))
@click.argument("columns", nargs=-1, type=click.Choice(NAME_CHOICES, case_sensitive=True))
